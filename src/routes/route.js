...
import AssignedPreRaceDetail from '../components/referee/AssignedPreRaceDetail';
import FinalResult from '../components/referee/FinalResult';
import ViolationLog from '../components/referee/ViolationLog';
...
const appRoutes = [
    ...
    },
    {
        ...
        element: createElement(AssignedPreRaceDetail),
    },
    {
        path: "/referee/races/post-race",
        element: createElement(AssignedPostRace),
    ...
    {
        path: "/referee/races/post-race/violations",
        element: createElement(ViolationLog),
    },
    {
        path: "/referee/races/post-race/final-results",
        element: createElement(FinalResult),
    },
];
