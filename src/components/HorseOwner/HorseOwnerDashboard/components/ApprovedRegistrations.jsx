...
const styles = {
    ...
    modalSubtitle: { margin: "6px 0 0", fontSize: "13px", fontWeight: 600, color: "#64748b" },
    closeBtn: {
    ...
    infoLabel: { display: "block", fontSize: "11px", fontWeight: 800, textTransform: "uppercase", color: "#64748b" },
