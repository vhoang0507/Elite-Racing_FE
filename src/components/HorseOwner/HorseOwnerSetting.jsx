...
function HorseOwnerSetting() {
    const user = getAuthUser() || {};

    const fullName = readField(user, 'fullName') || 'Horse Owner';
    ...
    return (
        <HorseOwnerLayout activeKey="settings">
            <section className="grid gap-6 px-11 py-9 max-[860px]:px-5 max-[860px]:py-7">
                <div>
                    <div className="mb-2 flex items-center gap-2 text-[0.74rem] font-black uppercase text-[var(--admin-muted)]">
                        ...
                        <span>Horse Owner Settings</span>
                    </div>
...
export default HorseOwnerSetting;