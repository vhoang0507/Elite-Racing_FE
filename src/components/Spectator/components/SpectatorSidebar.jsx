...
const styles = {
    ...
    logo: { fontWeight: "bold", fontSize: "14px", color: "#8B0000", padding: "0 16px 20px", borderBottom: "1px solid #eee" },
    userInfo: { display: "flex", alignItems: "center", gap: "10px", padding: "16px", borderBottom: "1px solid #eee" },
    avatar: { width: "36px", height: "36px", borderRadius: "50%", backgroundColor: "#8B0000", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: "bold" },
