            ...
            <section className={pageShellClass}>
                ...
                <div className="grid grid-cols-[220px_1fr] gap-6 max-lg:grid-cols-1">
                    <div className={`${panelClass} h-fit p-3`}>
                        <button
                            type="button"
                            className="mb-2 flex w-full items-center gap-3 rounded-md bg-[#f6dfdb] px-4 py-3 text-left font-semibold text-[var(--admin-primary)]"
                        >
                            <FaUser />
                            Profile Settings
                        </button>
                        ...
                        <button
                            type="button"
                            className="flex w-full items-center gap-3 rounded-md px-4 py-3 text-left font-semibold text-[#5c4642] hover:bg-[#fff3ef]"
                        >
                            <FaLock />
                            Account Security
                        </button>
                    ...
                    <div className="space-y-6">
                        <div className={`${panelClass} p-8`}>
                            ...
                            <div className="mb-8 flex items-center gap-5 max-[720px]:flex-col max-[720px]:items-start">
                                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[#f6dfdb] text-[var(--admin-primary)]">
...
function SummaryTile({ icon, label, value }) {
    ...
    return (
        <article className="flex min-w-0 items-center gap-3 rounded-md border border-[var(--admin-border)] bg-[#fff8f6] p-4">
            <div className="grid h-10 w-10 flex-none place-items-center rounded-md bg-[#ffe8e4] text-[var(--admin-primary)]">
                <Icon />
            </div>
